...
def calculate_expected_rME(y_true, y_pred, min_value, max_value):
    ...
    return loss
def loss_expected_rME(max_value, min_value):
    def rME(y_true, y_pred):
        return calculate_expected_rME(y_true, y_pred, min_value, max_value)
    return rME


def calculate_pdf_rME(target, prediction, min_value, max_value):
    ...
    loss = calculate_expected_rME(ev_target, ev_prediction, min_value, max_value)

    return loss

def loss_pdf_rME(max_value, min_value):
    def pdf_rME(target, prediction):
        return calculate_pdf_rME(target, prediction, min_value, max_value)
    return pdf_rME

# same thing, just relative mean squared error
def calculate_expected_rMSE(y_true, y_pred, min_value, max_value):
    y_true = tf.cast(y_true, dtype=tf.float32)
    y_pred = tf.cast(y_pred, dtype=tf.float32)
    min_value = tf.cast(min_value, dtype=tf.float32)
    max_value = tf.cast(max_value, dtype=tf.float32)
    ...
    y_pred = tf.math.add(y_pred, min_value)
    ...
    return loss
def loss_expected_rMSE(max_value, min_value):
    def rMSE(y_true, y_pred):
        return calculate_expected_rMSE(y_true, y_pred, min_value, max_value)
    return rMSE

def calculate_pdf_rMSE(target, prediction, min_value, max_value):
    ...
    loss = calculate_expected_rMSE(ev_target, ev_prediction, min_value, max_value)

    return loss
def loss_pdf_rMSE(max_value, min_value):
    def pdf_rMSE(target, prediction):
        return calculate_pdf_rMSE(target, prediction, min_value, max_value)
    return pdf_rMSE
...
def pdf_tile_to_fc_loss(target, prediction, distance_tensor):
    ...
    loss = tf.math.maximum(loss, 1e-9)
